...
const TonelEventos: React.FC<TonelEventosProps> = ({ eventos, tonel }) => {
  const eventosFiltrados = tonel ? eventos.filter(e => e.idtonel === tonel.idtonel) : eventos;
